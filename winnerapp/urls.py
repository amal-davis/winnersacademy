...
urlpatterns = [
    ...
    path('topers',views.topers,name='topers'),
    path('career',views.career,name='career'),
    path('careers_section',views.careers_section,name='careers_section'),
    path('admin_careers',views.admin_careers,name='admin_careers'),
    path('carerr_delete/<int:career_id>/',views.carerr_delete,name='carerr_delete'),
    path('add_syllabus',views.add_syllabus,name='add_syllabus'),
    path('add_syllabus_section',views.add_syllabus_section,name='add_syllabus_section'),
    path('syllabus_delete/<int:syllabus_id>/',views.syllabus_delete,name='syllabus_delete'),
    path('login_page',views.login_page,name='login_page'),
    path('signin',views.signin,name='signin'),
    path('add_courese',views.add_courese,name='add_courese'),
